...
// Type: Kvartplata.Classes.Policy
...
namespace Kvartplata.Classes
{
  ...
  {
    [Browsable(false)]
    public virtual int PolicyNum { get; set; }
    ...
    public override bool Equals(object obj)
    {
      ...
      return policy != null && (this.LsClient.ClientId == policy.LsClient.ClientId && this.DBeg == policy.DBeg);
    }
